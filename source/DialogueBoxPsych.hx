...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	function addCharacter(char:FlxSprite, name:String) {
		switch(name) {
            ...
            case 'protagonists':
                char.frames = Paths.getSparrowAtlas('dialogue/Protagonists_Dialogue');
                char.animation.addByPrefix('bfIdle', 'bf portrait heart idle', 24, true);
                char.animation.addByPrefix('bfTalk', 'bf portrait heart idle', 24, true);
				char.animation.addByPrefix('bffsIdle', 'bfFS portrait heart idle', 24, true);
                char.animation.addByPrefix('bffsTalk', 'bfFS portrait heart idle', 24, true);
				char.animation.addByPrefix('picoIdle', 'pico portrait heart idle', 24, true);
                char.animation.addByPrefix('picoTalk', 'pico portrait heart idle', 24, true);
				char.animation.addByPrefix('gfIdle', 'gf portrait heart idle', 24, true);
                char.animation.addByPrefix('gfTalk', 'gf portrait heart idle', 24, true);	
				char.flipX = !char.flipX;

            //I CAN'T CODE THE TALK ANIMATION BECAUSE I'M A DUMB.				
				
			case 'spinel':
                char.frames = Paths.getSparrowAtlas('dialogue/Spinel_Dialogue');
                char.animation.addByPrefix('spinelIdle', 'spinel portrait heart idle', 24, true);
                char.animation.addByPrefix('spinelTalk', 'spinel portrait heart idle', 24, true);
				char.animation.addByPrefix('spinelfIdle', 'spinelF portrait heart idle', 24, true);
                char.animation.addByPrefix('spinelfTalk', 'spinelF portrait heart idle', 24, true);
				char.animation.addByPrefix('spinelfsIdle', 'spinelFS portrait heart idle', 24, true);
                char.animation.addByPrefix('spinelfsTalk', 'spinelFS portrait heart idle', 24, true);
				char.animation.addByPrefix('spinelbtIdle', 'spinelBT portrait heart idle', 24, true);
                char.animation.addByPrefix('spinelbtTalk', 'spinelBT portrait heart idle', 24, true);

			case 'sceneF':
                char.frames = Paths.getSparrowAtlas('dialogues/cutscenesFriends','heart');
				char.animation.addByPrefix('sceneone', 'sceneOne', 24, true);
				char.animation.addByPrefix('scenetwo', 'sceneTwo', 24, true);
				char.animation.addByPrefix('scenethree', 'sceneThree', 24, true);
				char.animation.addByPrefix('scenefour', 'sceneFour', 24, true);
				char.animation.addByPrefix('scenefive', 'sceneFive', 24, true);
				char.animation.addByPrefix('scenesix', 'sceneSix', 24, true);
				char.animation.addByPrefix('sceneseven', 'sceneSeven', 24, true);
				char.animation.addByPrefix('sceneeight', 'sceneEight', 24, true);
				char.width = 2000;
				char.height = 1145;
                char.x = 0;
                char.y = 0;	
            ...
            case 'sceneBT':
                char.frames = Paths.getSparrowAtlas('dialogues/cutscenesBetrayed','heart');
				char.animation.addByPrefix('sceneone', 'sceneOne', 24, true);
				char.animation.addByPrefix('scenetwo', 'sceneTwo', 24, true);
				char.animation.addByPrefix('scenethree', 'sceneThree', 24, true);
				char.animation.addByPrefix('scenefour', 'sceneFour', 24, true);
				...
				char.animation.addByPrefix('sceneseven', 'sceneSeven', 24, true);
				char.animation.addByPrefix('sceneeight', 'sceneEight', 24, true);
				char.animation.addByPrefix('scenenine', 'sceneNine', 24, true);
				char.animation.addByPrefix('sceneten', 'sceneTen', 24, true);
				char.animation.addByPrefix('sceneeleven', 'sceneEleven', 24, true);
				char.animation.addByPrefix('scenetwelve', 'sceneTwelve', 24, true);
				char.animation.addByPrefix('scenethirteen', 'sceneThirteen', 24, true);
				char.animation.addByPrefix('sceneBADTIME', 'sceneEEEE', 24, true);
				char.width = 2000;
				char.height = 1145;
                char.x = 0;
                char.y = 0;		
            ...
            case 'scenePOST':
                char.frames = Paths.getSparrowAtlas('dialogues/cutscenesPostbetrayed','heart');
				char.animation.addByPrefix('sceneone', 'sceneOne', 24, true);
				char.animation.addByPrefix('scenetwo', 'sceneTwo', 24, true);
				char.width = 2000;
				char.height = 1145;
	...
	public function new(?dialogueList:Array<String>, song:String)
	{
		...
		blackVoid = new FlxSprite(-500, -500).makeGraphic(FlxG.width * 2, FlxG.height * 2, FlxColor.BLACK);
	    ...
	    box = new FlxSprite(40, 370);
		box.frames = Paths.getSparrowAtlas('dialogueBoxesGarden');
		box.scrollFactor.set();
		box.antialiasing = ClientPrefs.globalAntialiasing;
		box.animation.addByPrefix('normal', 'speech bubble normal', 24);
		box.animation.addByPrefix('normalOpen', 'Speech Bubble Normal Open', 24, false);
		box.animation.addByPrefix('angry', 'speech bubble normal', 24);
		box.animation.addByPrefix('angryOpen', 'Speech Bubble Normal Open', 24, false);
		box.animation.addByPrefix('center-normal', 'speech bubble normal', 24);
		box.animation.addByPrefix('center-normalOpen', 'Speech Bubble Normal Open', 24, false);
		box.animation.addByPrefix('center-angry', 'speech bubble normal', 24);
		box.animation.addByPrefix('center-angryOpen', 'Speech Bubble Normal Open', 24, false);
		box.visible = false;
