...
class WeekData {
	...
	public static var songsNames:Array<Dynamic> = [
		['Friends', 'Flowers', 'Forgive'],								//Tutorial, this one isn't added to Freeplay, instead it is added from assets/preload/freeplaySonglist.txt
	...
	public static var loadDirectory:Array<String> = [
		'heart', //Tutorial loads "tutorial" folder on assets/
		null,	//Week 1
		null,	//Week 2
		null,	//Week 3
		null,	//Week 4
